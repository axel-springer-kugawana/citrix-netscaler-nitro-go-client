...
func (key LbvserverAppfwpolicyBindingKey) to_id_params(qsKey string) (string, map[string]string) {
	var _ = strconv.Itoa
...
func (key LbvserverAppfwpolicyBindingKey) to_id_filter() (string, map[string]string) {
...
func (c *NitroClient) CountLbvserverAppfwpolicyBinding() (int, error) {
	results := count_lbvserver_appfwpolicy_binding_result{}
