...
func (key LbvserverCachepolicyBindingKey) to_id_filter() (string, map[string]string) {
...
func (c *NitroClient) CountLbvserverCachepolicyBinding() (int, error) {
	results := count_lbvserver_cachepolicy_binding_result{}
