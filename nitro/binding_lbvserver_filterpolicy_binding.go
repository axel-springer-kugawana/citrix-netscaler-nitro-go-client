...
func (resource LbvserverFilterpolicyBinding) ToKey() LbvserverFilterpolicyBindingKey {
	key := LbvserverFilterpolicyBindingKey{
		resource.Name,
		resource.Policyname,
	}
...
func (key LbvserverFilterpolicyBindingKey) to_id_params(qsKey string) (string, map[string]string) {
	var _ = strconv.Itoa
...
func (key LbvserverFilterpolicyBindingKey) to_id_args() (string, map[string]string) {
	return key.to_id_params("args")
}

func (key LbvserverFilterpolicyBindingKey) to_id_filter() (string, map[string]string) {
...
func (c *NitroClient) AddLbvserverFilterpolicyBinding(resource LbvserverFilterpolicyBinding) error {
...
type list_lbvserver_filterpolicy_binding_result struct {
...
func (c *NitroClient) ListLbvserverFilterpolicyBinding() ([]LbvserverFilterpolicyBinding, error) {
	results := list_lbvserver_filterpolicy_binding_result{}
...
func (c *NitroClient) CountLbvserverFilterpolicyBinding() (int, error) {
	results := count_lbvserver_filterpolicy_binding_result{}
