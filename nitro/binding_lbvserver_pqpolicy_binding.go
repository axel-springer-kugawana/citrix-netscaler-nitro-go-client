...
func (resource LbvserverPqpolicyBinding) ToKey() LbvserverPqpolicyBindingKey {
	key := LbvserverPqpolicyBindingKey{
		resource.Name,
		resource.Policyname,
	}
...
func (key LbvserverPqpolicyBindingKey) to_id_params(qsKey string) (string, map[string]string) {
	var _ = strconv.Itoa
...
func (key LbvserverPqpolicyBindingKey) to_id_args() (string, map[string]string) {
	return key.to_id_params("args")
}

func (key LbvserverPqpolicyBindingKey) to_id_filter() (string, map[string]string) {
...
func (c *NitroClient) AddLbvserverPqpolicyBinding(resource LbvserverPqpolicyBinding) error {
...
type list_lbvserver_pqpolicy_binding_result struct {
...
func (c *NitroClient) ListLbvserverPqpolicyBinding() ([]LbvserverPqpolicyBinding, error) {
	results := list_lbvserver_pqpolicy_binding_result{}
...
func (c *NitroClient) CountLbvserverPqpolicyBinding() (int, error) {
	results := count_lbvserver_pqpolicy_binding_result{}
