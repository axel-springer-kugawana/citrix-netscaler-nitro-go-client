...
func (resource LbvserverTmtrafficpolicyBinding) ToKey() LbvserverTmtrafficpolicyBindingKey {
	key := LbvserverTmtrafficpolicyBindingKey{
		resource.Name,
		resource.Policyname,
	}
...
func (key LbvserverTmtrafficpolicyBindingKey) to_id_params(qsKey string) (string, map[string]string) {
	var _ = strconv.Itoa
...
func (key LbvserverTmtrafficpolicyBindingKey) to_id_args() (string, map[string]string) {
	return key.to_id_params("args")
}

func (key LbvserverTmtrafficpolicyBindingKey) to_id_filter() (string, map[string]string) {
...
func (c *NitroClient) AddLbvserverTmtrafficpolicyBinding(resource LbvserverTmtrafficpolicyBinding) error {
...
type list_lbvserver_tmtrafficpolicy_binding_result struct {
...
func (c *NitroClient) ListLbvserverTmtrafficpolicyBinding() ([]LbvserverTmtrafficpolicyBinding, error) {
	results := list_lbvserver_tmtrafficpolicy_binding_result{}
...
func (c *NitroClient) CountLbvserverTmtrafficpolicyBinding() (int, error) {
	results := count_lbvserver_tmtrafficpolicy_binding_result{}
