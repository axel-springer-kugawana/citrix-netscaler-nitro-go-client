...
func (resource LbvserverTransformpolicyBinding) ToKey() LbvserverTransformpolicyBindingKey {
	key := LbvserverTransformpolicyBindingKey{
		resource.Name,
		resource.Policyname,
		resource.Bindpoint,
	}
...
func (c *NitroClient) AddLbvserverTransformpolicyBinding(resource LbvserverTransformpolicyBinding) error {
...
type list_lbvserver_transformpolicy_binding_result struct {
