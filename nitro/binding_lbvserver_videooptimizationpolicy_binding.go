...
func (key LbvserverVideooptimizationpolicyBindingKey) to_id_params(qsKey string) (string, map[string]string) {
	var _ = strconv.Itoa
...
func (key LbvserverVideooptimizationpolicyBindingKey) to_id_filter() (string, map[string]string) {
...
func (c *NitroClient) CountLbvserverVideooptimizationpolicyBinding() (int, error) {
	results := count_lbvserver_videooptimizationpolicy_binding_result{}
