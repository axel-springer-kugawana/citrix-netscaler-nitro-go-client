...
func (key LbvserverKey) to_id_params(qsKey string) (string, map[string]string) {
	var _ = strconv.Itoa
...
func (key LbvserverKey) to_id_filter() (string, map[string]string) {
...
func (resource Lbvserver) ToUpdate() LbvserverUpdate {
	update := LbvserverUpdate{
		resource.Name,
		resource.Ipv46,
		resource.Ippattern,
		resource.Ipmask,
...
type update_lbvserver_payload struct {
	Update LbvserverUpdate `json:"lbvserver"`
}

func (c *NitroClient) UpdateLbvserver(update LbvserverUpdate) error {
...
func (resource Lbvserver) ToUnset() LbvserverUnset {
	unset := LbvserverUnset{
		resource.Name,
		false,
		false,
		false,
