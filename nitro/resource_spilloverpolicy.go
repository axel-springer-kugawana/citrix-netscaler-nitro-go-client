...
func (c *NitroClient) GetSpilloverpolicy(key SpilloverpolicyKey) (*SpilloverpolicyResource, error) {
	var results struct {
		Spilloverpolicy []SpilloverpolicyResource
	}
...
func (c *NitroClient) ListSpilloverpolicy() ([]SpilloverpolicyResource, error) {
	var results struct {
		Spilloverpolicy []SpilloverpolicyResource
	}
...
func (c *NitroClient) AddSpilloverpolicy(resource SpilloverpolicyResource) error {
...
func (c *NitroClient) UpdateSpilloverpolicy(resource SpilloverpolicyResource) error {
